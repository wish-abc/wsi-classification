...
class PLModule(LightningModule):
    def __init__(self, config_dict):
        ...
        self.log_f = 'logs/main_9_folds_weight.txt'
    ...
    def test_epoch_end(self, outputs):
        ...
        with open(self.log_f, 'a') as f:
            f.write(f"main_9_folds: \n")
            f.write(f'fold: {fold}\n')
            f.write(f'k_sample: {k_sample}\n')
            f.write(f'weight: {contra_weight}\n')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--k-sample', type=float, default=0.35)
    parser.add_argument('--contra-weight', type=float, default=0.2)
    parser.add_argument('--config-path', type=str, default='configs/main_9.yaml',
